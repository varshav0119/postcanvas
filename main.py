...
def process(link):
  ...
  try:
    ...
    if r.status_code == 200 and "pdf" in content_type:
      user_response = input(
        "This is an open access PDF file. Download? (y/n) ")
...
# introduction
print(
  "Welcome, I'm your file download helper. For now, I am only able to help you download open access PDFs!"
)

# user input for links
links_string = input(
  "Paste in links to files, each link separated by a comma. Hit 'Enter' once you're done\n"
)
